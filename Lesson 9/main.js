...
for (const course of coursesArray) {
    ...
    courseElement.classList.add('www')
    let titleElement = document.createElement('h2');
    titleElement.classList.add('qqq')
...
let xxx = ['Main','Products','About us','Contacts']

let ul = document.body.getElementsByClassName('menu')[0]

for (const main of xxx) {
...
for (const construct of coursesAndDurationArray) {
    let divElement = document.createElement('div')
    divElement.innerText = `${construct.title} ${construct.monthDuration}`
    document.body.appendChild(divElement)
}
...
document.getElementById('kokos').onclick = function() {
